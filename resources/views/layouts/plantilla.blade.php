...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/estilos_globales.css') }}">
    ...
    <script
        src="https://cdn.datatables.net/2.2.1/js/dataTables.bootstrap5.jshttps://cdn.datatables.net/2.2.1/js/dataTables.bootstrap5.js">
    </script>
